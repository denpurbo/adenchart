<template>
  <header class="navbar sticky-top navbar-light navbar-expand-lg navigation-clean">
    <div class="container">
      <h1 class="mb-0">
        <router-link class="navbar-brand" to="/" title="Trading Charts">Aden - Trading Charts</router-link>
      </h1>
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <router-link class="nav-link" to="/" v-bind:title="$t('home')" exact>{{ $t('home') }}</router-link>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://github.com/denpurbo" target="_blank" rel="noopener noreferrer">{{ $t('about') }}</a>
          </li>
